      ...
      <div className="timeline-panel">
        ...
        <div className="timeline-body">
          <p className="text-muted">
            ...
            More recently I'm helping web pros manage their customers through
            {' '}
            <a href="https://hub.godaddy.com" target="_blank" rel="noreferrer">GoDaddy Hub</a>
            .
          </p>
        </div>
      </div>
      ...
      <div className="timeline-panel">
        ...
        <div className="timeline-body">
          <p className="text-muted">
            ...
            As the senior web developer for the organization, I was responsible for collecting project requirements, implementing new work flows, writing code and consulting internal stakeholders.
          </p>
        </div>
      </div>
    </li>
